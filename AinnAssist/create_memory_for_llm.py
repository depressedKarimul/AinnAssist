...
DATA_PATH = "/app/storage/data/"  # Use volume path if using Railway Volumes
DB_FAISS_PATH = "/app/storage/db_faiss"  # Use volume path for persistence
...
def generate_vector_store():
    ...
    if not os.path.exists(DB_FAISS_PATH):
        print("[INFO] FAISS index not found. Generating...")
        ...
        print(f"[INFO] Vector store already exists at: {DB_FAISS_PATH}")
